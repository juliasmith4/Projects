...

{
	...
	// pay particular attention to correctly implementing the copy constructor, assignment operator, and destructor


 std::cout << "copy constructor\n";
    Matrix original(6, 3, 4.04);
     std::cout << "og matrix:\n" << original << "\n";
...
// destructor called here automatically bc scope ends ^^
...
Matrix mat2(3, 3, 9.9);
 ...
 std::cout << "mat1 before :\n" << mat1 << "\n";
std::cout << "mat2 before:\n" << mat2 << "\n";

// assign mat2 to mat1
mat1 = mat2;

std::cout << "mat1 after assignment:\n" << mat1 << "\n";

// change mat1 
mat1.set(0,0, 55.5);
std::cout << "After changing mat1:\n";
std::cout << "mat1:\n" << mat1 << "\n";
std::cout << "mat2 :\n" << mat2 << "\n";
...
//transpose 
// create two matrix 
Matrix mat4(6,3,4.04);
Matrix mat5(9, 2, 9.0);
std::cout << "\n\nTRANSPOSE:\n\n\n" ;

std::cout << "mat4 before transpose:\n" << mat4 << "\n";
std::cout << "mat5 before transpose:\n" << mat5 << "\n";

mat4.transpose();
mat5.transpose();

std::cout << "mat4 after transpose:\n" << mat4 << "\n";
std::cout << "mat5 after transpose:\n" << mat5 << "\n";


std::cout << "MULT:\n\n\n" ;
//mult by coefficient 
Matrix mat6(6,3,4.04);

std::cout << "mat6 before mult:\n" << mat6 << "\n";

mat6.multiply_by_coefficient(2.0);

std::cout << "mat6 after mult:\n" << mat6 << "\n";



//get_col 
std::cout << "\n\n\nGET COL:\n\n\n" ;
Matrix mat9(6,3,4.04);
...
//row or col = 0
Matrix mat7(0,3,4.04);


std::cout << "mat7,  row = 0:\n" << mat7 << "\n";


double* theRow = mat7.get_row(1);

std::cout << "theRow after trying to get row of mat7:\n" << theRow << "\n";

	delete [] theRow; //Remember we need to clean up dynamic allocations.

std::cout << "QUARTER:\n\n\n" ;
//quartering with odd dimensions
Matrix mat8(3,6,4.04);
mat8.set(0,0,1);
mat8.set(0,1,2);
mat8.set(0,2,3);
mat8.set(0,3,4);
...
mat8.set(2,4,2);
mat8.set(2,5,3);
std::cout << "mat8,  row = 3, col = 6:\n" << mat8 << "\n";


Matrix* mat8_quarters = mat8.quarter();

std::cout << "Mat 8 quarter 1\n" << mat8_quarters[0] << "\n";
std::cout << "Mat 8 quarter 2n" << mat8_quarters[1] << "\n";
std::cout << "Mat 8 quarter 3\n" << mat8_quarters[2] << "\n";
std::cout << "Mat 8 quarters 4\n" << mat8_quarters[3] << "\n";

//trivial 
	delete [] mat8_quarters; //Remember we need to clean up dynamic allocations.
